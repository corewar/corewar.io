...
//         Helper.hookChaiInstructionAssertion();
//     });
...
//         prepareCore(5, [
//             TestHelper.buildInstruction(3, OpcodeType.DAT, ModifierType.A, ModeType.Direct, 0, ModeType.Direct, 0)
//         ]);

//         var context = buildContext(3, 0, 0);

//         this.this.exec.commandTable[OpcodeType.DAT].apply(this.exec, [context]);
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 2),
//                 TestHelper.buildInstruction(3, OpcodeType.MOV, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 4),
//             ];
...
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 4));
//         });
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 2),
//                 TestHelper.buildInstruction(3, OpcodeType.MOV, ModifierType.B, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 4),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 2));
//         });
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 1));
//         });
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 4));
//         });
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 2),
//                 TestHelper.buildInstruction(3, OpcodeType.MOV, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 4),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 2));
//         });
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 2),
//                 TestHelper.buildInstruction(3, OpcodeType.MOV, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 4),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 1));
//         });
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 2),
//             TestHelper.buildInstruction(3, OpcodeType.MOV, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 3, ModeType.Direct, 4),
//         ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.ADD, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 19),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 15, ModeType.Direct, 19));
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 22));
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 21));
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 16, ModeType.Direct, 19));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.ADD, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 19),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 15, ModeType.Direct, 22));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.ADD, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 19),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 16, ModeType.Direct, 21));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.ADD, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 19),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.SUB, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 19),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 19));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.SUB, ModifierType.B, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 19),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 16));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.SUB, ModifierType.AB, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 19),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 17));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.SUB, ModifierType.BA, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 19),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 10, ModeType.Direct, 19));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.SUB, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 19),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 16));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.SUB, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 19),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 10, ModeType.Direct, 17));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.SUB, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 13, ModeType.Direct, 19),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.MUL, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 5, ModeType.Direct, 7),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 10, ModeType.Direct, 7));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.MUL, ModifierType.B, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 5, ModeType.Direct, 7),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 5, ModeType.Direct, 21));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.MUL, ModifierType.AB, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 5, ModeType.Direct, 7),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 5, ModeType.Direct, 14));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.MUL, ModifierType.BA, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 5, ModeType.Direct, 7),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 15, ModeType.Direct, 7));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.MUL, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 5, ModeType.Direct, 7),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 10, ModeType.Direct, 21));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.MUL, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 5, ModeType.Direct, 7),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 15, ModeType.Direct, 14));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.MUL, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 5, ModeType.Direct, 7),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 7),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 3),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 5, ModeType.Direct, 3));
//         });
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 5, ModeType.Immediate, 2),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.B, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 2, ModeType.Direct, 7),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 2, ModeType.Direct, 3));
//         });
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 5),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.AB, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 3, ModeType.Direct, 16),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 3, ModeType.Direct, 5));
//         });
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 7, ModeType.Immediate, 4),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.BA, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 9, ModeType.Direct, 2),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 2, ModeType.Direct, 2));
//         });
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 10),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 2),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 10),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 10),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 7),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 3),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 5, ModeType.Immediate, 0),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.B, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 2, ModeType.Direct, 7),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 5),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.AB, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 3, ModeType.Direct, 16),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 7, ModeType.Immediate, 0),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.BA, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 9, ModeType.Direct, 2),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 10),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 0),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 10),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 5, ModeType.Direct, 10));
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 0),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 10),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 2),
//                 TestHelper.buildInstruction(3, OpcodeType.DIV, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 10),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 7),
//                 TestHelper.buildInstruction(3, OpcodeType.MOD, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 3),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 1, ModeType.Direct, 3));
//         });
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 5, ModeType.Immediate, 2),
//                 TestHelper.buildInstruction(3, OpcodeType.MOD, ModifierType.B, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 2, ModeType.Direct, 7),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 2, ModeType.Direct, 1));
//         });
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 5),
//                 TestHelper.buildInstruction(3, OpcodeType.MOD, ModifierType.AB, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 3, ModeType.Direct, 16),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 3, ModeType.Direct, 1));
//         });
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 7, ModeType.Immediate, 4),
//                 TestHelper.buildInstruction(3, OpcodeType.MOD, ModifierType.BA, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 9, ModeType.Direct, 2),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 1, ModeType.Direct, 2));
//         });
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.MOD, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 11),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 2),
//                 TestHelper.buildInstruction(3, OpcodeType.MOD, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 11),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.MOD, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 11),
//             ];
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 11, ModeType.Direct, 1));
...
//             expect(core.readAt(null, 4)).to.be.thisInstruction(
//                 TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.X, ModeType.Direct, 1, ModeType.Direct, 10));
...
//         prepareCore(5, [
//             TestHelper.buildInstruction(1, OpcodeType.JMP, ModifierType.A, ModeType.Direct, 3, ModeType.Direct, 0)
//         ]);
...
//         var instructions = [
//             TestHelper.buildInstruction(3, OpcodeType.JMZ, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 1),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(3, OpcodeType.JMZ, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 1),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(3, OpcodeType.JMZ, ModifierType.BA, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 1),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(3, OpcodeType.JMZ, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(3, OpcodeType.JMZ, ModifierType.AB, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//         ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(3, OpcodeType.JMZ, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(3, OpcodeType.JMZ, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(3, OpcodeType.JMZ, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//             ];
...
//         var instructions = [
//             TestHelper.buildInstruction(3, OpcodeType.JMN, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(3, OpcodeType.JMN, ModifierType.BA, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(3, OpcodeType.JMN, ModifierType.AB, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 1),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(3, OpcodeType.JMN, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(3, OpcodeType.JMN, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(3, OpcodeType.JMN, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//         ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(3, OpcodeType.DJN, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 0),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(3, OpcodeType.DJN, ModifierType.BA, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 0),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(3, OpcodeType.DJN, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 2),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(3, OpcodeType.DJN, ModifierType.AB, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 2),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(3, OpcodeType.DJN, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 1),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(3, OpcodeType.DJN, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 1),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(3, OpcodeType.DJN, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 1),
//             ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//             TestHelper.buildInstruction(3, OpcodeType.CMP, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 0),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 3),
//             TestHelper.buildInstruction(3, OpcodeType.CMP, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 4),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 1),
//             TestHelper.buildInstruction(3, OpcodeType.CMP, ModifierType.B, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 3),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 1),
//             TestHelper.buildInstruction(3, OpcodeType.CMP, ModifierType.B, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 4, ModeType.Immediate, 1),
//         ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//                 TestHelper.buildInstruction(3, OpcodeType.CMP, ModifierType.AB, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 3),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 1),
//                 TestHelper.buildInstruction(3, OpcodeType.CMP, ModifierType.BA, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 0),
//             ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//             TestHelper.buildInstruction(3, OpcodeType.CMP, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 0),
//         ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//                 TestHelper.buildInstruction(3, OpcodeType.CMP, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 1),
//             ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//             TestHelper.buildInstruction(3, OpcodeType.CMP, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.X, ModeType.Immediate, 0, ModeType.Immediate, 0),
//             TestHelper.buildInstruction(3, OpcodeType.CMP, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Direct, 0, ModeType.Immediate, 0),
//             TestHelper.buildInstruction(3, OpcodeType.CMP, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Direct, 0),
//             TestHelper.buildInstruction(3, OpcodeType.CMP, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//         ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 1),
//                 TestHelper.buildInstruction(3, OpcodeType.CMP, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 1),
//             ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//             TestHelper.buildInstruction(3, OpcodeType.SEQ, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 0),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 1),
//             TestHelper.buildInstruction(3, OpcodeType.SEQ, ModifierType.B, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 3),
//         ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//                 TestHelper.buildInstruction(3, OpcodeType.SEQ, ModifierType.AB, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 3),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 1),
//                 TestHelper.buildInstruction(3, OpcodeType.SEQ, ModifierType.BA, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 0),
//             ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//             TestHelper.buildInstruction(3, OpcodeType.SEQ, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 0),
//         ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//                 TestHelper.buildInstruction(3, OpcodeType.SEQ, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 1),
//             ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//             TestHelper.buildInstruction(3, OpcodeType.SEQ, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//             TestHelper.buildInstruction(3, OpcodeType.SNE, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 1),
//             TestHelper.buildInstruction(3, OpcodeType.SNE, ModifierType.B, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 1),
//         ];
...
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 1),
//             TestHelper.buildInstruction(3, OpcodeType.SNE, ModifierType.B, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 4, ModeType.Immediate, 3),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 0),
//             TestHelper.buildInstruction(3, OpcodeType.SNE, ModifierType.AB, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 3),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 1),
//             TestHelper.buildInstruction(3, OpcodeType.SNE, ModifierType.BA, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//             TestHelper.buildInstruction(3, OpcodeType.SNE, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 0),
//         ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 0),
//                 TestHelper.buildInstruction(3, OpcodeType.SNE, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 1),
//             ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//             TestHelper.buildInstruction(3, OpcodeType.SNE, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.MOV, ModifierType.F, ModeType.Immediate, 0, ModeType.Immediate, 0),
//         ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.SLT, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 4),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 4),
//                 TestHelper.buildInstruction(3, OpcodeType.SLT, ModifierType.A, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 2),
//                 TestHelper.buildInstruction(3, OpcodeType.SLT, ModifierType.B, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 1),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 4, ModeType.Immediate, 1),
//                 TestHelper.buildInstruction(3, OpcodeType.SLT, ModifierType.B, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 2),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 4, ModeType.Immediate, 1),
//                 TestHelper.buildInstruction(3, OpcodeType.SLT, ModifierType.AB, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 3),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 4),
//                 TestHelper.buildInstruction(3, OpcodeType.SLT, ModifierType.BA, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 5),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 5, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.SLT, ModifierType.BA, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 4, ModeType.Immediate, 1),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.SLT, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 4),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 1),
//                 TestHelper.buildInstruction(3, OpcodeType.SLT, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 4),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.SLT, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 4),
//             ];
...
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 3, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.SLT, ModifierType.X, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 4, ModeType.Immediate, 2),
//             ];
...
//             var instructions = [
//                 TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 3),
//                 TestHelper.buildInstruction(3, OpcodeType.SLT, ModifierType.I, ModeType.Direct, -1, ModeType.Direct, 1),
//                 TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 4),
//             ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 1, ModeType.Immediate, 2),
//             TestHelper.buildInstruction(3, OpcodeType.SPL, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.DAT, ModifierType.F, ModeType.Immediate, 2, ModeType.Immediate, 0),
//         ];
...
//         var instructions = [
//             TestHelper.buildInstruction(2, OpcodeType.MOV, ModifierType.B, ModeType.Immediate, 1, ModeType.AIndirect, 2),
//             TestHelper.buildInstruction(3, OpcodeType.NOP, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1),
//             TestHelper.buildInstruction(4, OpcodeType.ADD, ModifierType.AB, ModeType.APostIncrement, 2, ModeType.BPostIncrement, 0),
//         ];
...
//         expect(instructions[0]).to.be.thisInstruction(TestHelper.buildInstruction(
//             2, OpcodeType.MOV, ModifierType.B, ModeType.Immediate, 1, ModeType.AIndirect, 2));

//         expect(instructions[1]).to.be.thisInstruction(TestHelper.buildInstruction(
//             3, OpcodeType.NOP, ModifierType.F, ModeType.Direct, -1, ModeType.Direct, 1));

//         expect(instructions[2]).to.be.thisInstruction(TestHelper.buildInstruction(
