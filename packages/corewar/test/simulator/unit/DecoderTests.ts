...
describe('Decoder', () => {
    ...
    Helper.runTest(
        [
            ...
            {
                core: ['NOP.I $2, $1', 'ADD.AB *-1, *1', 'DAT.F $-1, $1'],
                ip: 1,
                e: ['DAT.F $-1, $1', 'ADD.AB *-1, *1']
            },
            {
                core: ['NOP.I $1, $2', 'ADD.AB @-1, @1', 'DAT.F $5, $-1'],
                ip: 1,
                e: ['DAT.F $5, $-1', 'ADD.AB @-1, @1']
            },
    ...
    Helper.runTest([{ core: ['ADD.BLAH #3, #4'], ip: 0, e: ['3, 3'] }], context => {
